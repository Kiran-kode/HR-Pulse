...
const Login = () => {
  ...
  const inputClasses = "mt-2 block w-full rounded-md border border-gray-300 px-4 py-3 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm";
  const errorClasses = "mt-1 text-sm text-red-600";

  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50  sm:px-6 md:p-0  lg:px-30 lg:py-30">
        ...
        <div className="bg-white rounded-lg shadow-xl overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="p-8 sm:p-12 lg:p-16 flex flex-col justify-center">
              <div className="mb-8">
                <h1 className="font-bold text-4xl text-gray-900 mb-3">Welcome Back</h1>
                ...
                <div>
                  ...
                  <div className="relative mt-2">
                    ...
                    <input
                      ...
                      className={`${inputClasses} pl-12 ${errors.email ? 'border-red-500 focus:ring-red-500' : ''}`}
                    />
                  </div>
                ...
                <div>
                  ...
                  <div className="relative mt-2">
                    ...
                    <input
                      ...
                      className={`${inputClasses} pl-12 pr-12 ${errors.password ? 'border-red-500 focus:ring-red-500' : ''}`}
                    />
                    <button
                      type="button"
